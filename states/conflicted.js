          ...
          if (!this.jumped && this.player.y > 500 ) {
            this.jumped = true
                        ...
                        if (!this.ended && this.player.y > 900 ) {
                          ...
                          //   bg.destroy()
            that.game.add.text(100, 256, 'there is no nuclear war out here, but there is also not much of anything. cool.', { fontSize: '42px', fill: '#000', font: 'Impact', wordWrap: true, wordWrapWidth: '300', backgroundColor: '#FFF' });
            that.canMove = false
            setTimeout(function () {
